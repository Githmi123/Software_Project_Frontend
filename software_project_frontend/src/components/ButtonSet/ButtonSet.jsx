  ...
  return (
    <div>
      ...
      <Stack
        ...
        alignContent="center"
        marginLeft={"3vh"}
        className={`button-set ${menuOpen ? "show" : ""}`}
      >
        <LeftPaneButton
          icon={DashboardIcon}
          name="Dashboard"
        ...
        <LeftPaneButton
          ...
          name="New Assignment"
          link="/NewAssignment"
          isSelected={selectedButton === "New Assignment"}
          onClick={() => handleSelectedButton("New Assignment")}
        />
        <LeftPaneButton
          icon={BookIcon}
          name="My Modules"
          link="/MyModulePage"
          isSelected={selectedButton === "My Modules"}
          onClick={() => handleSelectedButton("My Modules")}
        />
        <LeftPaneButton
          icon={SettingsIcon}
          name="Settings"
        ...
        <LeftPaneButton
          ...
          onClick={() => handleSelectedButton("Help")}
        />
      </Stack>
